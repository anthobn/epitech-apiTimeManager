defmodule ApiTimeManagerWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ApiTimeManagerWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/apiTimeManager_web/templates",
        namespace: ApiTimeManagerWeb
  ...
  defp view_helpers do
    quote do
      ...
      import ApiTimeManagerWeb.ErrorHelpers
      import ApiTimeManagerWeb.Gettext
      alias ApiTimeManagerWeb.Router.Helpers, as: Routes
    end
  end
